    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: 'All our handmade woven bags and artisan products are 100% authentic and sourced directly from skilled artisans. We guarantee the quality and sustainable sourcing of all products sold.'
        },
        {
          subtitle: 'Variations',
          text: 'Due to the handmade nature of our products using organic materials, slight variations in color, weave, or appearance may occur. This is a hallmark of artisan craftsmanship and does not affect the quality of the product.'
        }
      ]
    }
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            Welcome to Seriqueavenue. These Terms of Service ("Terms") govern your use of our website and the purchase 
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            ...
            Seriqueavenue or its content suppliers and is protected by Indian and international copyright laws.
          </p>
          <p className="text-gray-600 leading-relaxed">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            To the maximum extent permitted by law, Seriqueavenue shall not be liable for any indirect, incidental, 
